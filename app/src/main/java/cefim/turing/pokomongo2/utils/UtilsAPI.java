package cefim.turing.pokomon.utils;
...
public class UtilsAPI {
    ...
    public void get(final APICallback activity, String url, String params, String token) {
        ...
        mOkHttpClient.newCall(request).enqueue(new Callback() {
            ...
            public void onResponse(Call call, final Response response) throws IOException {
                ...
                if (response.isSuccessful()) {
                    activity.successCallback(response);
                } else {
                    activity.failCallback(response);
                }
            }
        });
    }

    public void post(final APICallback activity, String url, String params, String token) {
