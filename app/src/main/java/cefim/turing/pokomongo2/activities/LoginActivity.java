...
public class LoginActivity extends AppCompatActivity implements APICallback {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSignUpTextView = findViewById(R.id.sign_up);
    ...
    private void attemptLogin() {
        ...
        if (cancel) {
            ...
            try {
                UtilsAPI.getInstance().post(this, UtilsAPI.URL_LOGIN, params, "");
            } catch (IOException e) {
                showProgress(false);
        ...
        mHandler.post(new Runnable() {
            ...
            public void run() {
                ...
                try {
                    ...
                    UtilsPreferences.getPreferences(mContext).setKey("token", obj.getString("token"));
