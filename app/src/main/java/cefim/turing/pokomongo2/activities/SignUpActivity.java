...
public class SignUpActivity extends AppCompatActivity implements APICallback {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Button mButtonSignIn = findViewById(R.id.email_sign_in_button);
    ...
    private void attemptSignUp() {
        ...
        if (cancel) {
            ...
            try {
                UtilsAPI.getInstance().post(this, UtilsAPI.URL_SIGN_UP, params, "");
            } catch (IOException e) {
                showProgress(false);
    ...
    @Override
    public void failCallback(Response response) {
        Log.d("lol", "Fail");
        mHandler.post(new Runnable() {
                          @Override
                          public void run() {
